...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--test-split",
        default="data_cache/test_sft_data/test_split_cleaned",
        help="Optional path to the cleaned test split to help resolve neighbour metadata",
    )
    parser.add_argument(
        "--output-dir",
        default="simliarity_report/datasets/train_similarity_reports",
...
async def async_main(args: argparse.Namespace) -> None:
    ...
    extra_splits = args.extra_metadata_split or [
        "data_cache/train_sft_data/train_split_cleaned",
        "data_cache/test_sft_data/test_split_cleaned",
    ]
