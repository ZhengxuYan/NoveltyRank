#!/usr/bin/env python3
"""CLI for generating classification-mode DPO pairs for a specific category."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate classification DPO pairs for a category")
...
def main():
    ...
    counts = build_classification_pairs(paths)
    logger.info("Category artifacts stored under %s", paths.root)
    logger.info(
        "Generated classification pairs: train=%d, test=%d",
